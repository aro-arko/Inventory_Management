                                    ...
                                    return (
                                        <div key={i} className="p-6 flex items-center justify-between hover:bg-slate-50 transition-colors">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <p className="font-bold text-slate-800">{summary.split(" — ")[0]}</p>
                                                    <p className="text-sm text-slate-500">{summary.split(" — ")[1].split(" (")[0]}</p>
                                                </div>
                                            </div>
                                            <div className={cn(
                                                "px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider",
                                                isOut ? "bg-red-100 text-red-700" : isLow ? "bg-orange-100 text-orange-700" : "bg-emerald-100 text-emerald-700"
                                            )}>
                                                {summary.match(/\(([^)]+)\)/)?.[1] || "OK"}
                                            </div>
                                        </div>
